...
Revision ID: d1d544b905fe
Revises: 
Create Date: 2026-05-15 16:46:33.443088
...
def upgrade():
    ...
    sa.CheckConstraint('invested_amount <= full_amount', name='check_invested_le_full'),
